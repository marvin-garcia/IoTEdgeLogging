...
namespace IoTEdgeLogger
{
    ...
    public static class Logger
    {
        ...
        public static readonly Dictionary<string, LogEventLevel> LogLevelDictionary = new Dictionary<string, LogEventLevel>(StringComparer.OrdinalIgnoreCase)
        {
